...
const Home = (props) => {
  ...
  return (
    <>
        <HeaderFooterLayout title="BookOwl / Home" description="This is the main home page where you can find books which are on sale or bestsellers, as well as popular blog posts.">
            <Background>
            ...
            <button id="Scroll-top" aria-label="Scroll-top" className="fixed bottom-0 right-0 p-4 text-shingle-fawn-dark bg-shingle-fawn/[.4] rounded-full m-2" onClick={scrollToTop}>
              <FaArrowUp />
            </button>
